...
public class TestDoubleLinkedList extends BaseTest {
    ...
    public void testDeleteBasics() {
    		...
    		assertListMatches(new String[] {"a", "c", "d"}, list);
    ...
    public void testDeleteBad() {
    		...
    		//test delete in empty list
    		IList<String> listEmpty = this.makeInstance();
    		try {
        			listEmpty.delete(0);
        			fail("Expected IndexOutOfBoundsException");
    		} catch (IndexOutOfBoundsException ex) {
